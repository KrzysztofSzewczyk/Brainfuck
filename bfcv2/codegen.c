...
int dynamic_mem = 1;
int mem_grow_rate = 10;
int mem_size = 65536; //Modified to accomplish unofficial standard.
int check_bounds = 0;
int dump_core = 0;
int bfbignum = 0;
int optimize_c = 0;
...
/* Code strings */
char *bfstr_type = "unsigned int"; //WARN: If not working, change to unsigned char.
char *bfstr_htype = NULL;
char *bfstr_ptr = "ptr";
char *bfstr_buffer = "bf_buffer";
char *bfstr_get = "*%s = (BFTYPE) getchar ();\n"; //WARN: If porting to windows, change getchar to getch.
