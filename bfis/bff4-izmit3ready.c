...
/**
 * Modified by Krzysztof Palaiologos Szewczyk, this
 * interpreter can execute izmit3-generated brainfuck at (too bad that)
 * lower speed.
 *
 * I'm currently working on better implementation.
 * https://uw426.mikr.us/izmit3/
 */
